...
function AnimatedStatUnderline({ className = '' }) {
  return (
    <motion.span
      className={[
        'pointer-events-none z-10 mt-1.5 block h-0.5 w-full max-w-[5rem] rounded-full bg-[#0D9E73] transition-colors duration-300 group-hover:bg-white',
        className,
      ]
        .filter(Boolean)
        .join(' ')}
...
function AchievementCardNumeric({ item }) {
  ...
  return (
    <motion.article
      variants={fadeUp}
      className="mentor-ach-hover-fill group relative flex min-h-[188px] flex-col overflow-hidden bg-transparent transition-shadow duration-300 hover:shadow-[0_20px_40px_-16px_rgba(13,158,115,0.35)]"
    >
        ...
        <div className="relative z-10 mt-2 min-h-[3.25rem]">
          <span className="block text-[3rem] font-extrabold leading-none tracking-tight text-[#0D9E73] transition-colors duration-300 tabular-nums group-hover:text-white">
            {formatCount(n)}
            {item.suffix}
          </span>
      ...
      <div className="relative z-10 flex flex-1 flex-col justify-center px-3 py-7 text-center sm:px-5">
        ...
        <div className="relative z-10 mt-2 min-h-[3.25rem]">
          <motion.p
            ...
            className="text-[3rem] font-extrabold leading-none tracking-tight text-[#0D9E73] transition-colors duration-300 group-hover:text-white"
          >
            {item.bigText}
          </motion.p>
          <AnimatedStatUnderline className="mx-auto" />
...
const MentorSection = () => (
  <section id="mentor" className="relative scroll-mt-24 bg-white">
    ...
    <div
      className="pointer-events-none absolute bottom-0 left-0 top-0 z-[5] w-[8px] bg-gradient-to-b from-[#0D9E73] via-[#2EBF8A] to-[#A8F0DC]"
      aria-hidden
    />
    ...
    <div className="mentor-block1-stripes relative">
      ...
      >
        <motion.p
          variants={fadeUp}
          className="text-center text-[11px] font-bold uppercase tracking-[0.26em] text-[#0D9E73] sm:text-xs"
        >
        ...
        >
          ...
          <motion.div variants={fadeUp} className="relative mx-auto mb-14 w-full max-w-[340px] lg:mx-0 lg:mb-0 lg:max-w-none">
            <div
              ...
              style={{
                background:
                  'radial-gradient(closest-side, rgba(13, 158, 115, 0.08) 0%, transparent 72%)',
              }}
              aria-hidden
            />

            <div className="relative z-[1] mx-auto w-full max-w-[320px] lg:mx-0">
              <div className="overflow-hidden rounded-card-lg shadow-[0_20px_50px_-12px_rgba(13,158,115,0.4),0_0_0_1px_rgba(255,255,255,0.5)] ring-1 ring-white/60">
                <div
                  className="flex max-h-[480px] min-h-[320px] flex-col items-center justify-center bg-gradient-to-br from-[#0D9E73] to-[#A8F0DC] px-8 py-10 sm:min-h-[360px] sm:py-12"
                >
                  <MentorSilhouette className="h-44 w-[10.5rem] text-[#066a4f] drop-shadow-[0_2px_8px_rgba(255,255,255,0.25)] sm:h-52 sm:w-[12rem]" />
              ...
              <div className="absolute bottom-0 left-1/2 z-[2] w-[max(88%,260px)] max-w-[92%] -translate-x-1/2 translate-y-1/2">
                <div className="rounded-full border border-white/90 bg-white px-5 py-2.5 text-center shadow-[0_18px_40px_-8px_rgba(26,26,46,0.28),0_0_0_1px_rgba(13,158,115,0.12)] sm:px-6 sm:py-3">
          ...
          <motion.div variants={fadeUp} className="relative pt-2 text-center lg:pt-2 lg:text-left">
            <div className="relative flex gap-3 sm:gap-5 lg:gap-6">
              <div
                className="mt-1 h-[220px] w-1 shrink-0 rounded-full bg-gradient-to-b from-[#0D9E73] via-[#2EBF8A] to-[#A8F0DC] sm:mt-2 sm:h-[288px] sm:w-[4px]"
                aria-hidden
              />
        ...
        <motion.div
          ...
          className="mentor-ach-strip relative z-[1] mt-12 [grid-auto-rows:1fr] overflow-hidden rounded-t-card-lg border border-[#0D9E73]/18 bg-gradient-to-b from-[#E8FAF4] to-white shadow-[inset_0_1px_0_rgba(255,255,255,0.85)] sm:mt-14"
        >
    ...
    <div className="relative overflow-hidden mentor-quote-mesh">
      ...
      >
        <div className="relative">
          ...
          <motion.p
            variants={fadeUp}
            className="relative z-[1] mt-7 text-sm font-semibold sm:text-base"
            style={{ color: '#A8F0DC' }}
          >
          ...
          >
            <img
              src="https://placehold.co/128x128/1a7a5c/FFFFFF?font=dm-sans&text=RL"
              alt="Rohit Lal"
            ...
            <div className="min-w-0 text-left">
              ...
              <p className="text-sm italic text-[#A8F0DC]">The FinancialDoctor</p>
            </div>
          </motion.div>
